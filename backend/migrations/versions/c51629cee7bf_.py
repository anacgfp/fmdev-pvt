...
Revision ID: c51629cee7bf
Revises: 1e969255444f
Create Date: 2021-11-06 18:38:38.916804
...
def upgrade():
    ...
    op.add_column('datasources', sa.Column('typeOfData', sa.String(), nullable=False))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('datasources', 'typeOfData')
